...
from currencymodel import CNNNet
 
model_conv = CNNNet(num_classes=7)
...
model_ft = train.train(model_conv,optimizer_conv, loss_fn, exp_lr_scheduler,pp.device, pp.image_dataloaders, dataset_size=pp.dataset_size,epochs=500 )
